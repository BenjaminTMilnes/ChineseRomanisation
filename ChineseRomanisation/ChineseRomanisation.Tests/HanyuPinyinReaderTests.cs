...
namespace ChineseRomanisation.Tests
{
    public class HanyuPinyinReaderTests
    {
        ...
        [InlineData("bo", "bo", "po")]
        [InlineData("do", "do", "to")]
        [InlineData("go", "go", "kuo")]
        [InlineData("po", "po", "p'o")]
        [InlineData("to", "to", "t'o")]
        [InlineData("ko", "ko", "k'uo")]
        [InlineData("zo", "zo", "tso")]
        [InlineData("zho", "zho", "cho")]
        [InlineData("jo", "jo", "cho")]
        [InlineData("co", "co", "ts'o")]
        [InlineData("cho", "cho", "ch'o")]
        [InlineData("qo", "qo", "ch'o")]
        [InlineData("fo", "fo", "fo")]
        [InlineData("so", "so", "so")]
        [InlineData("sho", "sho", "shuo")]
        [InlineData("xo", "xo", "hso")]
        [InlineData("ho", "ho", "huo")]
        [InlineData("lo", "lo", "lo")]
        [InlineData("ro", "ro", "jo")]
        ...
        [InlineData("müe", "müe", "müeh")]
        [InlineData("nüe", "nüe", "nüeh")]
        [InlineData("büe", "büe", "püeh")]
        [InlineData("düe", "düe", "tüeh")]
        [InlineData("güe", "güe", "küeh")]
        [InlineData("püe", "püe", "p'üeh")]
        [InlineData("tüe", "tüe", "t'üeh")]
        [InlineData("küe", "küe", "k'üeh")]
        [InlineData("züe", "züe", "tsüeh")]
        [InlineData("zhüe", "zhüe", "chüeh")]
        [InlineData("jüe", "jüe", "chüeh")]
        [InlineData("cüe", "cüe", "ts'üeh")]
        [InlineData("chüe", "chüe", "ch'üeh")]
        [InlineData("qüe", "qüe", "ch'üeh")]
        [InlineData("füe", "füe", "füeh")]
        [InlineData("süe", "süe", "süeh")]
        [InlineData("shüe", "shüe", "shüeh")]
        [InlineData("xüe", "xüe", "hsüeh")]
        [InlineData("hüe", "hüe", "hüeh")]
        [InlineData("lüe", "lüe", "lüeh")]
        [InlineData("rüe", "rüe", "jüeh")]
